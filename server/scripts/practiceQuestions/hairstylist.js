export default [
  {
    ...
    "topicId": "A",
    "topicLabel": "MWA A — Occupational Health, Safety and Hygiene",
  ...
  },
  {
    ...
    "topicId": "A",
    "topicLabel": "MWA A — Occupational Health, Safety and Hygiene",
    "question": "A reusable salon cape becomes contaminated with blood. What should the hairstylist do?",
    "options": [
      "Put the cape in regular trash even though it is reusable",
      "Keep it separate from clean linens, handle it with appropriate protection, and launder it according to the applicable infection-control procedure",
      "Automatically dispose of every blood-contaminated reusable cape as biomedical waste",
      "Spray the cape with fragrance and use it for the next client"
    ],
    "correctIndex": 1,
    "explanation": "A reusable cape is not automatically biomedical waste simply because it is blood-contaminated. Avoid direct contact with the blood; handle and contain soiled textiles so they do not contaminate clean items, and launder them according to the setting's infection-prevention procedures and applicable local requirements. Dispose of the cape if it cannot be safely cleaned or if the relevant rules require disposal.",
    "order": 9,
  ...
  },
  {
    ...
    "topicId": "A",
    "topicLabel": "MWA A — Occupational Health, Safety and Hygiene",
    "question": "A disinfectant label specifies a 5-minute wet contact time. What should the stylist do after pre-cleaning a reusable tool?",
    "options": [
      "Spray the tool and wipe it dry immediately",
      "Keep the tool wet with the product for the full labeled 5 minutes",
      "Dilute the product more heavily to shorten the contact time",
      "Skip disinfection if no debris is visible"
    ],
    "correctIndex": 1,
    "explanation": "Follow the product's labeled directions. After cleaning, the treated surface must remain wet for the specified contact time to achieve the claimed level of disinfection.",
    "order": 30,
  ...
  },
  {
    ...
    "topicId": "A",
    "topicLabel": "MWA A — Tools and Equipment",
    "question": "What is the main reason for checking the electrical cord on a blow dryer before using it?",
    "options": [
      "To determine whether the dryer will produce extra shine",
      "To confirm the dryer is compatible with every styling attachment",
      "To identify fraying or exposed wiring that could create an electrical hazard",
      "To determine how much styling product is needed"
    ],
    "correctIndex": 2,
    "explanation": "Inspect electrical tools before use. A damaged cord or exposed wiring can create shock or fire hazards; remove a damaged appliance from service.",
    "order": 36,
  ...
  },
  {
    ...
    "topicId": "A",
    "topicLabel": "MWA A — Client Consultation",
    "question": "A client shows a photograph of a colour that would require extensive lightening, but their ends are fragile. What is the best consultation response?",
    "options": [
      "Promise the pictured result in one appointment",
      "Assess the hair, explain realistic options and limitations, and agree on a safer service plan",
      "Apply the strongest developer available to save time",
      "Ignore the photograph and choose a shade without discussion"
    ],
    "correctIndex": 1,
    "explanation": "Consultation combines the client's goal with analysis of the hair's condition and prior services. Explain achievable outcomes, limitations, and alternatives before agreeing on a chemical service.",
    "order": 48,
  ...
  },
  {
    ...
    "topicId": "A",
    "topicLabel": "MWA A — Communication",
    "question": "A client uses a preferred name that differs from the name on an older appointment record. What should the stylist do?",
    "options": [
      "Use the older name because it appears in the record",
      "Ask respectfully which name the client prefers and update the record as appropriate",
      "Ask other clients to decide which name to use",
      "Avoid addressing the client by name for the entire visit"
    ],
    "correctIndex": 1,
    "explanation": "Respectful service involves asking how a client wishes to be addressed and recording relevant preferences accurately while maintaining confidentiality.",
    "order": 56,
  ...
  },
  {
    ...
    "topicId": "B",
    "topicLabel": "MWA B — Hair and Scalp Analysis",
    "question": "What does 'hair density' mean, and how can high density affect application planning?",
    "options": [
      "It means the diameter of one hair strand and always calls for stronger chemicals",
      "It means the number of hairs in a given scalp area; dense hair may require manageable subsections and sufficient product for even saturation",
      "It is another name for hair elasticity",
      "It determines developer strength without considering hair condition or product directions"
    ],
    "correctIndex": 1,
    "explanation": "Hair density describes the number of hairs growing within a given scalp area, not individual strand diameter. Dense hair may require more time, manageable subsections and enough product to saturate each section consistently. Density alone does not justify stronger chemicals or longer processing; select formulations and timing based on analysis and manufacturer directions.",
    "order": 76,
  ...
  },
  {
    ...
    "topicId": "B",
    "topicLabel": "MWA B — Hair and Scalp Analysis",
    "question": "During analysis, hair feels smooth near the roots but rough and catches on the fingers toward the ends. What should the stylist record?",
    "options": [
      "Uniform porosity along the entire shaft",
      "Different porosity conditions in different hair zones",
      "A guaranteed allergy to colour",
      "Identical chemical processing needs from roots to ends"
    ],
    "correctIndex": 1,
    "explanation": "Differences in surface texture can indicate different conditions along the hair shaft. Record the zones and confirm hair condition with appropriate tests before planning chemical services.",
    "order": 84,
  ...
  },
  {
    ...
    "topicId": "B",
    "topicLabel": "MWA B — Hair and Scalp Analysis",
    "question": "Why should a hairstylist examine the scalp before beginning a shampoo service?",
    "options": [
      "To diagnose every skin disease",
      "To identify visible concerns or contraindications and decide whether the service is appropriate",
      "To determine the client's natural hair colour level only",
      "To eliminate the need for client consultation"
    ],
    "correctIndex": 1,
    "explanation": "A pre-service scalp assessment can reveal visible irritation, broken skin, or other concerns. Hairstylists assess service suitability but do not diagnose medical conditions.",
    "order": 85,
  ...
  },
  {
    ...
    "topicId": "B",
    "topicLabel": "MWA B — Shampooing and Conditioning",
    "question": "What is the most effective way to prevent excessive tangling when shampooing long hair?",
    "options": [
      "Pile the full length onto the crown and scrub vigorously",
      "Cleanse the scalp gently while allowing the lengths to hang naturally",
      "Brush the hair repeatedly while heavily lathered",
      "Twist the hair into tight knots before applying shampoo"
    ],
    "correctIndex": 1,
    "explanation": "Gentle scalp manipulation and keeping lengths aligned reduce friction and tangling. Aggressively piling or rubbing long hair together can increase mechanical damage.",
    "order": 101,
  ...
  },
  {
    ...
    "topicId": "C",
    "topicLabel": "MWA C — Haircutting",
    "question": "Which cutting line creates an A-line bob perimeter that is shorter at the back and progressively longer toward the front?",
    "options": [
      "Horizontal",
      "Vertical",
      "Diagonal forward",
    ...
    "correctIndex": 2,
    "explanation": "A diagonal-forward cutting line produces a perimeter that becomes progressively longer toward the face, giving an A-line bob its shorter-back, longer-front silhouette. Graduation or stacking in the back is a separate technique that creates additional weight and volume; an A-line perimeter alone does not necessarily include graduation.",
    "order": 103,
  ...
  },
  {
    ...
    "topicId": "C",
    "topicLabel": "MWA C — Haircutting",
    "question": "Why should a hairstylist check a haircut while the client is sitting in a natural, upright position?",
    "options": [
      "To make all haircuts identical",
      "To assess how the perimeter and balance appear in the client's normal posture",
      "To replace all section-by-section cross-checking",
      "To ensure both sides are cut with the head tilted"
    ],
    "correctIndex": 1,
    "explanation": "Head position changes the apparent fall and length of the hair. Checking the cut with the client upright helps reveal imbalances that may be hidden when the head is tilted.",
    "order": 148,
  ...
  },
  {
    ...
    "topicId": "C",
    "topicLabel": "MWA C — Haircutting",
    "question": "When cutting a fringe on hair with a strong cowlick, which step helps avoid an unexpectedly short result?",
    "options": [
      "Stretch the hair as tightly as possible before cutting",
      "Observe the natural growth pattern and allow for spring-back before establishing the final length",
      "Cut the entire fringe at the shortest desired point immediately",
      "Use thinning scissors at the roots regardless of the design"
    ],
    "correctIndex": 1,
    "explanation": "Cowlicks and natural texture affect how a fringe settles after release and drying. Assess growth direction and allow for movement before committing to the final length.",
    "order": 149,
  ...
  },
  {
    ...
    "topicId": "C",
    "topicLabel": "MWA C — Facial and Nape Hair",
    "question": "When outlining a client's neckline, which approach best establishes an appropriate shape and position?",
    "options": [
      "Always shave the neckline as high as possible",
      "Assess the natural growth pattern, consult the client about the intended shape, and outline carefully without imposing a fixed placement rule",
      "Always create a straight line regardless of the haircut",
      "Remove all hair below a universal two-finger measurement"
    ],
    "correctIndex": 1,
    "explanation": "Neckline placement and shape depend on the natural hairline, growth pattern, haircut design and client preference. There is no universal two-finger rule. A high or overly rigid outline may show regrowth sooner. Cutting or shaving does not make hair grow back thicker or coarser.",
    "order": 152,
  ...
  },
  {
    ...
    "topicId": "C",
    "topicLabel": "MWA C — Facial and Nape Hair",
    "question": "What should a hairstylist check before trimming around a client's ears?",
    "options": [
      "Whether the client prefers a specific music genre",
      "The ear's position, surrounding growth pattern, and safe access for the selected tool",
      "Only the colour of the hair",
      "Whether both ears are perfectly identical in shape"
    ],
    "correctIndex": 1,
    "explanation": "Ear shape and growth direction vary. Protect the ear, observe the hairline, and use controlled tool movements to create a safe, balanced outline.",
    "order": 157,
  ...
  },
  {
    ...
    "topicId": "D",
    "topicLabel": "MWA D — Wet Hair Styling",
    "question": "For a roller set, what usually happens if the hair is removed from the rollers before it is fully dry?",
    "options": [
      "The set may lose definition and longevity",
      "The curl becomes permanently fixed",
      "The hair's natural colour becomes lighter",
      "The rollers increase the hair's porosity permanently"
    ],
    "correctIndex": 0,
    "explanation": "Wet styling relies on the hair drying in the new shape. Removing rollers while the hair remains damp can weaken the temporary set and shorten its hold.",
    "order": 175,
  ...
  },
  {
    ...
    "topicId": "D",
    "topicLabel": "MWA D — Dry Hair Styling",
    "question": "Why should a hairstylist select a thermal tool temperature according to the client's hair condition?",
    "options": [
      "All hair types respond identically to maximum heat",
      "Fine, fragile, or previously processed hair may be more susceptible to heat damage",
      "Higher temperatures remove the need for sectioning",
      "Tool temperature affects only the speed of the stylist's movements"
    ],
    "correctIndex": 1,
    "explanation": "Hair condition influences heat tolerance. Use the lowest effective setting permitted by the tool and product directions, especially on fragile or chemically processed hair.",
    "order": 196,
  ...
  },
  {
    ...
    "topicId": "D",
    "topicLabel": "MWA D — Dry Hair Styling",
    "question": "What is the purpose of directing a blow dryer's nozzle along the hair shaft during smoothing?",
    "options": [
      "To lift cuticle scales deliberately",
      "To organize airflow from roots toward ends and support a smoother finish",
      "To replace the brush entirely",
      "To make the dryer safe to rest against the scalp"
    ],
    "correctIndex": 1,
    "explanation": "A concentrator nozzle controls airflow. Directing it down the hair shaft while using appropriate brush tension helps smooth the surface and limit unwanted frizz.",
    "order": 197,
  ...
  },
  {
    ...
    "topicId": "E",
    "topicLabel": "MWA E — Permanent Waving",
    "question": "A client has fine, highlighted hair with poor elasticity. What is the safest decision when considering a permanent wave?",
    "options": [
      "Choose the strongest alkaline wave to guarantee a curl",
      "Defer the chemical service, assess the hair's condition, and follow the product's contraindications and manufacturer directions",
      "Use an acid-balanced wave immediately after a protein treatment; this guarantees the hair can withstand processing",
      "Use the normal alkaline formula for half its processing time"
    ],
    "correctIndex": 1,
    "explanation": "Poor elasticity indicates that the hair may not withstand additional chemical processing. Defer the perm, assess the condition and service history, and follow the chosen product's contraindications and instructions. A conditioning or protein treatment does not guarantee that damaged hair has regained sufficient strength for a permanent wave.",
    "order": 214,
  ...
  },
  {
    ...
    "topicId": "E",
    "topicLabel": "MWA E — Permanent Waving",
    "question": "A test curl shows that the hair has not processed sufficiently, but the manufacturer's maximum processing time has been reached. What should the stylist do?",
    "options": [
      "Continue processing indefinitely until the curl forms",
      "Follow the manufacturer's instructions and reassess rather than exceeding the maximum time",
      "Apply additional heat without checking the product instructions",
      "Apply relaxer over the waving lotion"
    ],
    "correctIndex": 1,
    "explanation": "Perm processing limits are product-specific. Exceeding the manufacturer's maximum time or improvising extra heat can damage hair; follow instructions and reassess the service.",
    "order": 225,
  ...
  },
  {
    ...
    "topicId": "E",
    "topicLabel": "MWA E — Chemical Relaxers",
    "question": "Before a hydroxide relaxer retouch, why is it important to identify the line between new growth and previously relaxed hair?",
    "options": [
      "To apply relaxer to both areas equally",
      "To confine the retouch to new growth and avoid overlapping previously processed hair",
      "To determine which shampoo has the strongest fragrance",
      "To decide whether the haircut should be shorter"
    ],
    "correctIndex": 1,
    "explanation": "Previously relaxed hair has already undergone irreversible chemical changes. Identifying the demarcation line helps prevent overlapping product and excessive weakening or breakage.",
    "order": 247,
  ...
  },
  {
    ...
    "topicId": "F",
    "topicLabel": "MWA F — Hair Colouring",
    "question": "For a permanent oxidative colour system specifying 20-volume developer for approximately 1–2 levels of lift, which developer should the stylist select?",
    "options": [
      "5 vol. (1.5%)",
      "10 vol. (3%)",
      "20 vol. (6%)",
    ...
    "correctIndex": 2,
    "explanation": "In the specified colour system, 20-volume (6%) developer is the manufacturer's choice for approximately 1–2 levels of lift. Lift varies by colour line and hair characteristics; follow the particular product's formulation and developer instructions rather than treating volume-to-lift figures as universal.",
    "order": 250,
  ...
  },
  {
    ...
    "topicId": "F",
    "topicLabel": "MWA F — Hair Colouring",
    "question": "A client's resistant grey regrowth has insufficient coverage after a permanent-colour service. What is the best next formulation approach?",
    "options": [
      "Switch automatically to a semi-permanent colour",
      "Review the colour line's resistant-grey directions, including any natural-base or coverage series, mixing ratio, saturation and full processing time",
      "Automatically increase developer to 30 volume regardless of manufacturer guidance",
      "Apply the same formula to wet hair and shorten processing time"
    ],
    "correctIndex": 1,
    "explanation": "For resistant grey coverage, follow the manufacturer's recommendations for the specific colour system: appropriate natural-base or resistant-grey shades, developer, mixing ratio, thorough saturation and full processing time. Some lines recommend a specified proportion of natural shade with 20-volume developer. Raising developer strength indiscriminately can reduce deposit or produce an unintended result.",
    "order": 267,
  ...
  },
  {
    ...
    "topicId": "F",
    "topicLabel": "MWA F — Hair Colouring",
    "question": "When recording a custom hair colour formula, which information is most useful for reproducing the result at the next appointment?",
    "options": [
      "Only the retail price of the colour",
      "The shade or shades, mixing proportions, developer, application zones, and processing details",
      "Only the client's natural eye colour",
      "The stylist's preferred brush brand"
    ],
    "correctIndex": 1,
    "explanation": "Detailed formula records support consistency and safe future planning. Record products and ratios, developer, application areas, timing, and the result achieved.",
    "order": 275,
  ...
  },
  {
    ...
    "topicId": "F",
    "topicLabel": "MWA F — Lightening",
    "question": "A stylist plans an on-scalp lightening service. How should the maximum permitted developer strength be determined?",
    "options": [
      "Use 40 volume with every lightener to maximize lift",
      "Check the specific lightener's instructions for on-scalp use and do not exceed its permitted developer strength",
      "Use any developer strength if the stylist checks the hair often",
      "Use the maximum strength listed for off-scalp foils on the scalp too"
    ],
    "correctIndex": 1,
    "explanation": "On-scalp developer limits are product-specific and may differ from the same product's off-scalp limits. Read the lightener's on-scalp directions, use only approved products, developer strengths and mixing ratios, and respect processing and scalp-safety warnings. Some professional lighteners specify a 20-volume on-scalp maximum; that example is not a universal rule for all products.",
    "order": 277,
  ...
  },
  {
    ...
    "topicId": "F",
    "topicLabel": "MWA F — Lightening",
    "question": "A lightener permits 20-volume developer for on-scalp use and up to 40 volume for off-scalp use. Which developer limit applies to an on-scalp application?",
    "options": [
      "40 volume, because the higher off-scalp limit also applies to the scalp",
      "20 volume, because the manufacturer's on-scalp directions set a separate maximum",
      "60 volume, provided the application is quick",
      "No limit, provided the scalp feels comfortable"
    ],
    "correctIndex": 1,
    "explanation": "For this explicitly described product, 20 volume is the maximum allowed on the scalp. Its 40-volume off-scalp allowance does not authorize 40 volume on the scalp. Always follow the individual lightener's on-scalp application, developer, mixing and processing instructions; scalp heat does not justify exceeding them.",
    "order": 284,
  ...
  },
  {
    ...
    "topicId": "F",
    "topicLabel": "MWA F — Lightening",
    "question": "During a lightening service, why is it useful to check several test sections rather than only one?",
    "options": [
      "All hair processes at exactly the same rate",
      "Different areas can have different histories or porosity and may lighten unevenly",
      "Checking one section permanently changes all other sections",
      "It eliminates the need to monitor the manufacturer's processing limit"
    ],
    "correctIndex": 1,
    "explanation": "Natural regrowth, coloured lengths, and porous ends can respond differently. Monitoring representative sections helps identify uneven lift and protect compromised areas.",
    "order": 289,
  ...
  },
  {
    ...
    "topicId": "F",
    "topicLabel": "MWA F — Colour Correction",
    "question": "A client has an uneven result with noticeably lighter, more porous ends. What should guide the next colour-correction plan?",
    "options": [
      "Use one identical strong formula on every zone without assessment",
      "Assess each zone and choose application methods and products appropriate to its condition",
      "Apply additional lightener to the lightest areas first",
      "Ignore the client's previous colour history"
    ],
    "correctIndex": 1,
    "explanation": "Corrective colour requires a zone-by-zone assessment of existing level, tone, porosity, and chemical history. Application and processing may need to differ among zones.",
    "order": 303,
  ...
  },
  {
    ...
    "topicId": "F",
    "topicLabel": "MWA F — Colour Correction",
    "question": "Before attempting a major colour correction on hair with an uncertain history of previous colour applications, what should the hairstylist do to assess how the hair may respond?",
    "options": [
      "Apply the final colour formula to the entire head immediately",
      "Perform a strand test using the proposed products and follow the manufacturer’s directions",
      "Increase developer strength to overcome unknown colour buildup",
      "Skip the consultation if the hair looks healthy"
    ],
    "correctIndex": 1,
    "explanation": "A strand test on a small, representative section helps assess the hair’s response, potential lift or deposit, and signs of damage before a full colour correction. Review the service history, assess hair condition, and follow each product manufacturer’s directions; a strand test does not replace an allergy alert test when one is required.",
    "order": 304,
    "sourceQuestionNumber": "NEW-350"
  },
  {
    "tradeSlug": "hairstylist",
    "topicId": "G",
  ...
  },
  {
    ...
    "topicId": "G",
    "topicLabel": "MWA G — Hair Extensions",
    "question": "A client reports persistent tightness and scalp discomfort immediately after hair extensions are installed. What should the stylist do?",
    "options": [
      "Assure the client that pain is always normal for several weeks",
      "Check the attachment tension and adjust or remove problematic extensions as needed",
      "Add more extensions to distribute the weight",
      "Recommend vigorous brushing over the attachment points"
    ],
    "correctIndex": 1,
    "explanation": "Extensions should not create persistent traction or pain. Reassess the attachment and tension promptly to reduce stress on the hair and scalp.",
    "order": 317,
  ...
  },
  {
    ...
    "topicId": "G",
    "topicLabel": "MWA G — Specialized Services",
    "question": "When selecting a wig for a client with a sensitive scalp, what should be prioritized?",
    "options": [
      "The heaviest cap available for maximum hold",
      "Comfortable cap fit, suitable materials, and the client's preferences",
      "A style chosen solely by the stylist",
      "A cap deliberately smaller than the client's measurements"
    ],
    "correctIndex": 1,
    "explanation": "Wig selection should consider accurate fit, comfort, scalp sensitivity, secure placement, and the client's needs and preferences.",
    "order": 324,
  ...
  },
  {
    ...
    "topicId": "H",
    "topicLabel": "MWA H — Front Desk and Salon Operations",
    "question": "A hairstylist is running 20 minutes behind schedule. What is the most professional response to the next client?",
    "options": [
      "Say nothing until the client complains",
      "Explain the delay promptly, provide a realistic revised start time, and discuss available options",
      "Mark the client as late in the booking system",
      "Rush the service by skipping the consultation"
    ],
    "correctIndex": 1,
    "explanation": "Timely, transparent communication helps clients make an informed choice. Acknowledge delays and offer realistic options without compromising essential service steps.",
    "order": 332,
  ...
  },
  {
    ...
    "topicId": "H",
    "topicLabel": "MWA H — Business Fundamentals",
    "question": "A service sells for $90 and its directly attributable product cost is $15. Before accounting for labour and overhead, what is the contribution remaining?",
    "options": [
      "$15",
      "$75",
      "$90",
    ...
    "correctIndex": 1,
    "explanation": "Subtract the directly attributable product cost from the service revenue: $90 − $15 = $75. Labour, rent, and other operating costs still need to be covered.",
    "order": 350,
